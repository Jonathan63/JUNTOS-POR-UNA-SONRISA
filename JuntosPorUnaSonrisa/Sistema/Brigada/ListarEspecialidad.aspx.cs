    ...
    public partial class ListarEspecialidad : System.Web.UI.Page
    {
       private string F { get { string parametro = Request.QueryString["F"]; if (string.IsNullOrEmpty(parametro) == true) { return ""; } return parametro; } }
        ...
        protected void DisplayData()
        {
            ...
            var q = from x in bd.ESPECIALIDAD select x;
        ...
        protected void GriListado_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("~/Sistema/Brigada/Horarios_Especialidad.aspx?Modo=E&F=" + e.CommandArgument+"&R="+'A');
        ...
        {
            Response.Redirect("~/Sistema/Brigada/Horarios_Especialidad.aspx?Modo=C&R=" + 'A');
        }
    }
}