<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="ListarHorarios.aspx.cs" Inherits="JuntosPorUnaSonrisa.Sistema.Brigada.ListarHorarios" %>
                    ...
                    <div>
                        <asp:GridView runat="server" ID="GriListado"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="ID Horario" DataField="HORA_ID" />
                                <asp:BoundField HeaderText="Dias Laborales " DataField="HORA_DIAS" />
                                <asp:BoundField HeaderText="Hora de Ingreso " DataField="HORA_INGRESO" />
