<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="ListarEspecialidad.aspx.cs" Inherits="JuntosPorUnaSonrisa.Sistema.Brigada.ListarEspecialidad" %>
                    ...
                    <div>
                        <asp:GridView runat="server" ID="GriListado"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="ID Especialidad " DataField="TCON_ID" />
                                <asp:BoundField HeaderText="Nombre de la Especialidad " DataField="TCON_NOMBRE" />
