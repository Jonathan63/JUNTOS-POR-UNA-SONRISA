<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="ListarPersonas.aspx.cs" Inherits="JuntosPorUnaSonrisa.Sistema.Personas.ListarPersonas" %>
                    ...
                    <div>
                        <asp:GridView runat="server" ID="GriPersonas"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton runat="server" ImageUrl="~/Imagenes/apply.ico"
                                            ...
                                            CommandArgument='<%# Bind("ID_PERSONA") %>'
                                            ID="BtnSeleccionar" />
                                ...
                                <asp:BoundField HeaderText="Apellido Paterno " DataField="PER_APELLIDO_PATERNO" />
                                <asp:BoundField HeaderText="Apellido Materno " DataField="PER_APELLIDO_MATERNO" />
