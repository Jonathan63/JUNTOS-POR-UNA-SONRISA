<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="ListarDiagnostico.aspx.cs" Inherits="JuntosPorUnaSonrisa.Sistema.FichaOdontologica.ListarDiagnostico" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PHContenido" runat="server">
    ...
    <div class="container-fluid" id="ContenidoHolder">
        <h2 class="text-center">Listar Diagnostico</h2>
                    ...
                    <div class="text-center">
                        <asp:GridView runat="server" ID="GriPersonas"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton runat="server"
                                            ...
                                            CommandName="Editar"
                                            CommandArgument='<%# Bind("ID_DIAGNOSTICO") %>'
                                            ID="BtnEditar" />
                                ...
                                <asp:BoundField HeaderText="ID " DataField="ID_DIAGNOSTICO" />
                                <asp:BoundField HeaderText="DESCRIPCION " DataField="DESCRIPCION" />
                                <asp:BoundField HeaderText="CIE " DataField="CIE" />
                                <asp:BoundField HeaderText="PRE " DataField="PRE" />
                                <asp:BoundField HeaderText="DEF " DataField="DEF" />
