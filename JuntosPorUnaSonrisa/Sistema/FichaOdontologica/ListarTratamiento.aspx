<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="ListarTratamiento.aspx.cs" Inherits="JuntosPorUnaSonrisa.Sistema.FichaOdontologica.ListarTratamiento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PHContenido" runat="server">
    ...
    <div id="VentanaEmergente" class="Ventana">
        ...
        <br />
        <asp:Label ID="LblSubtitulo" Text="El Tratamiento Nº" runat="server"></asp:Label>
                    ...
                    <div class="text-center">
                        <asp:GridView runat="server" ID="GriPersonas"
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:ImageButton runat="server"
                                            ...
                                            CommandName="Editar"
                                            CommandArgument='<%# Bind("ID_SECION") %>'
                                            ID="BtnEditar" />
                                ...
                                <asp:BoundField HeaderText="FICHA ODONTOLOGICA" DataField="ID_ODONTO" />
                                <asp:BoundField HeaderText="SECION " DataField="ID_SECION" />
                                <asp:BoundField HeaderText="DIAGNOSTICO" DataField="DIAGNOSTICO" />
                                <asp:BoundField HeaderText="PRESCRIPCIONES " DataField="PRESCRIPCIONESA" />
